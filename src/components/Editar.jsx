...
class Editar extends React.Component {
  ...
  enviarDatos = (e) => {
    e.preventDefault();
    const{ id,nombre,apellido,dni,cuil,telefono,rol } = this.state.empleado;

    var datosEnviar= {id:id, nombre:nombre, apellido:apellido, dni:dni, cuil:cuil, telefono:telefono, rol:rol};
        ...
        <div className="card-body">
          <form onSubmit={this.enviarDatos}>
            ...
            <div className="form-group">
              ...
              <input type="text" readOnly className="form-control" name="id" id="id" value={empleado.id} aria-describedby="helpId" placeholder="" onChange={this.cambioValor}/>
